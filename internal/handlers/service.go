// Package handlers provides interface for service logic level.
package handlers
...
//
//go:generate mockery --name=Service --output=. --outpkg=handlers --filename=mock_service.gen_test.go --with-expecter --structname=MockService
